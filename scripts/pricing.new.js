...
const priceContainer1 = document.querySelector('#corporate-price');
const priceContainer2 = document.querySelector('#enterprise-price');
const priceContainer1Description = document.querySelector('#corporate-description');
const priceContainer2Description = document.querySelector('#enterprise-description');

function displaySelectedProduct(product) {

}

function setContent(product) {
  leftPricingColumnHeader.innerText = 'Core';
  rightPricingColumnHeader.innerText = 'Core + Essentials';

  priceContainer1.innerText = product.packages[0].subtitle;
...
const Products = {
  ...
  angularjs: {
    ...
    interest: 'angular',
    toggleElement: document.querySelector('#angular-toggle'),
    packages: [
      {
        title: 'Core',
  ...
  angular: {
    title: 'Angular NES', 
    interest: 'nesAngular',
    toggleElement: document.querySelector('#nes-angular-toggle'),
    packages: [
      {
        title: 'Corporate',
        subtitle: 'Contact Sales for Pricing',
  ...
  vue: {
    title: 'Vue2 NES',
    interest: 'vue',
    toggleElement: document.querySelector('#vue-toggle'),
    packages: [
      {
        title: 'Core',
        subtitle: 'Contact Sales for Pricing',
  ...
  protractor: {
    ...
    interest: 'protractor',
    toggleElement: document.querySelector('#protractor-toggle'),
    packages: [
      {
        title: 'Corporate',
  ...
  nesBootstrap: {
    title: 'Bootstrap NES',
    interest: 'bootstrap',
    toggleElement: document.querySelector('#bootstrap-toggle'),
    packages: [
      {
        title: 'Corporate',
  ...
  nesDrupal: {
    title: 'Drupal NES',
    interest: 'drupal',
    toggleElement: document.querySelector('#drupal-toggle'),
    packages: [
      {
        title: 'Drupal 7 Core',
        subtitle: 'Contact Sales for Pricing',
  ...
  jQuery: {
    title: 'jQuery NES',
    interest: 'jquery',
    toggleElement: document.querySelector('#jquery-toggle'),
    packages: [
      {
        title: 'Corporate',
        subtitle: 'Price Coming Soon',
